...
const TITLES = {
  ...
  staff: ["Staff", "Register cashiers — then assign to buses"],
  staffroles: ["Staff roles", "Cashier and other portal roles"],
  customers: ["Customers", "App registrations — phone + OTP"],
  corporate: ["Corporate companies", "Register companies — web portal login, wallet & employee approvals"],
