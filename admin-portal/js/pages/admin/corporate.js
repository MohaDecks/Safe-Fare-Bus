  ...
  content.innerHTML = `
    <div class="card">
      ...
      <p style="padding:0 22px 12px;color:var(--muted);font-size:0.85rem">
        Admin creates accounts here with <strong>email + password</strong>. Company signs in at this portal (<code>/admin/</code>) — not the mobile app.
        Company tops up its wallet and customers from the corporate portal.
      </p>
            ...
            ? `<table><thead><tr><th>#</th><th>Company</th><th>Contact</th><th>Login email</th><th>Wallet</th><th>Employees</th><th>Status</th><th></th></tr></thead><tbody>
              ${corps
                ...
                <td style="white-space:nowrap">
                  ${can("corporate.update") ? `<button type="button" class="btn btn-secondary btn-sm edit-corp" data-id="${c.id}">Edit</button>` : "—"}
                </td>
              </tr>`
                )
                .join("")}</tbody></table>`
